...
int main ()
{
	...
	if(correct_node_bytes)
		mark += 1;
	mark += (int)(scoreCheckResult(result_default) * 2 +
	              scoreCheckResult(result_init1  ) * 2 +
	              scoreCheckResult(result_init2  ) * 2);
	mark += (int)(scorePrintResult(print_result_default) +
	              scorePrintResult(print_result_init1  ) +
	              scorePrintResult(print_result_init2  ));
