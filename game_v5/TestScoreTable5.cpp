...
const int COMBINED_TEST_MARKS         = 27;
...
int main ()
{
	testHelperStartup("TestScoreTable5", COMPILE_AND_START_MARKS, TOTAL_MARKS);
	...
	*p_table_extra = *p_table_extra = *p_table_extra;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool invalid_correct = checkPrinted(captured_invalid, 0x00, true);
	cout << endl;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool blank_correct = checkPrinted(captured_blank, 0x00, true);
	cout << endl;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool single_correct = checkPrinted(captured_single, 0x20, true);
	cout << endl;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool triple_correct = checkPrinted(captured_triple, 0xE0, true);
	cout << endl;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool save1_correct = checkCopy(captured_save1A, captured_save1B, 0x00);
	cout << endl;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool save2_correct = checkCopy(captured_save2A, captured_save2B, 0x04);
	cout << endl;
	...
	cout << "----------------------------------------------------------------" << endl;
	bool save3_correct = checkCopy(captured_save3A, captured_save3B, 0x0D);
	cout << endl;
	...
	testHelperPrintSummaryLine("Self-assignment",            self_correct);
	testHelperPrintSummaryLine("Chained assignment",         chained_correct);
	testHelperPrintSummaryLine("Load constructor",           load_correct_count,         4);
	testHelperPrintSummaryLine("save function",              save_correct_count,         3);
                             ...
                             bool is_finished_without_crash)
{
	...
	if(correct_copy_fraction == 1.0)
		mark += 1;  // code is mostly checked with correct_copy_linked_list_fraction
	if(correct_delete_fraction == 1.0)
		mark += 1;  // code is mostly checked with correct_destroy_linked_list_fraction
	if(correct_assign_fraction == 1.0 && correct_self_assign && correct_chained_assign)
		mark += 1;  // code is mostly checked with correct_*_linked_list_fraction
	mark += (int)(correct_load_fraction * 5);
	mark += (int)(correct_save_fraction * 2);
