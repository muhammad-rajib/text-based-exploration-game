...
//               standard output.  If is_print == true, all
//               data captured since testHelperStartCapture was
//               called is printed.  Otherwise, nothing is
//               printed.
//
std::string testHelperEndCapture (
                                bool is_print_captured = true);

//
//  testHelperSplitWithoutEmpty
//
...
//           return { "ABC", "DEFG", "HIJ" }.
//
std::vector<std::string> testHelperSplitWithoutEmpty (
